...
# =============================================================================
# Agent-level events (from Agent agentic loop) — defined here for co-location,
# but only populated once Agent is built in NB03.
# =============================================================================
...
class AgentEvent:
    ...
    def tool_call_complete(
        ...
        # result is a ToolResult — but we avoid importing it here to
        # prevent circular deps.  The Agent will pass the right thing.
